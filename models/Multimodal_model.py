...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_class', type=int, default=4)  # 10 or 4
    parser.add_argument('--patch_size_L', type=int, default=72)  # 64
    parser.add_argument('--patch_size_C', type=int, default=2)  # 3
    parser.add_argument('--n_patches', type=int, default=128)  # 256
    parser.add_argument('--output_dim', type=int, default=160)  # 256
